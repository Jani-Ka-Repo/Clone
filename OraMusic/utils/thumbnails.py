...
async def get_thumb(videoid):
    ...
    try:
        ...
        try:
            font_title = ImageFont.truetype("OraMusic/assets/font.ttf", 45)
            font_details = ImageFont.truetype("OraMusic/assets/font2.ttf", 30)
            font_watermark = ImageFont.truetype("OraMusic/assets/font2.ttf", 25)
        except:
        ...
        stats_text = f"YouTube : {views} | Time : {duration} | Player : @Oramusicbot"
