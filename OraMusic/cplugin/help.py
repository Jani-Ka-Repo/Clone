...
from OraMusic.utils.inline.help import help_back_markup, private_help_panel, clone_help_panel, clone_back_markup
from OraMusic.utils import first_page
from OraMusic.utils import help_pannel
from OraMusic.utils.database import get_lang
...
from OraMusic.utils.stuffs.helper import Helper
from OraMusic.utils.database.clonedb import get_owner_id_from_db, get_cloned_support_chat, get_cloned_support_channel
...
def get_random_help_img():
    if HELP_IMG_URL:
        ...
        return HELP_IMG_URL
    return "https://files.catbox.moe/wn3ool.jpg" # Fallback
